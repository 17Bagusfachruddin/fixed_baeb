...
<html>
	...
	<body>
		...
		<div class="wrapper">
			<div class="inner">
				<form action="aksi-lupapassword.php" method="post">
					<h3 style="font-size: 21px;">Reset Password</h3>
					<p style="text-align: center;">silakan masukkan akun email Anda sehingga kami dapat membantu anda untuk reset password</p>
					<br>
