    	...
    	<div class="container-fluid">
    		<div class="row">
    			...
    			<div class="col-md-3 ftco-animate">
    				<div class="product">
    					<a href=details.php?id=<?=$fetch['id_product']?> class="img-prod">
    						<img style="height: 350px; width: 600px; max-width: 100%; max-height: 100%;" class="img-fluid" src="images/<?php echo $fetch['foto_product']?>" alt="Colorlib Template"></a>
    					<div class="text py-4 px-4">
    						<h3><a href="#" max><?php echo $fetch['nama_product'];?></a></h3>
    						<div class="d-flex">
    							<div class="pricing">
    						...
    						<p class="bottom-area d-flex">
    							<a href='details.php?id=<?=$fetch['id_product']?>' class='btn btn-primary py-3 px-5'>Add to Cart</a></p>  
